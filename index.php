...
<html lang="es">
    ...
    <body>
        ...
        <nav id="barra-principal">
            ...
            <div class="inicio-s">
                <img src="assets/img/icono.png" width="50px" onclick="location.href='pages/Inicio_sesion.php'">
            </div>
        </nav>
        <div class="menu">
            <ul>
        ...
        <div class="slider-content">
            <div class="slider-item active">
                <img src="assets/img/ciberseguridad.jpg" width="1000">
            </div>
            <div class="slider-item">
                <img src="assets/img/techsolutions.jpeg" width="1000">
            </div>
            <div class="slider-item">
                <img src="assets/img/businessman.jpg" width="1000">
            </div>
        </div>
        ...
        <div class="slider-dots">
            ...
            <div class ="quienes_somos">
                <h2>Quienes somos </h2>
                <div class="con_1">
                    <img src="assets/img/techsolutios.png" width="600px">
                    <div class="texto">
            ...
            <img src="assets/img/ceo.jpg" width="30%">
        </div>
    </div>
...
<footer><p><a href="pages/Contactos.php">Contacto</a></p>

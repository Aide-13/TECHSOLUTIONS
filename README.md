...
La tienda muestra productos y licencias de software con sus características y precios. El carrito de compras es completamente interactivo, pero **no procesa pagos reales**. Esto es intencional ya que operar una pasarela de pagos requiere permisos fiscales.

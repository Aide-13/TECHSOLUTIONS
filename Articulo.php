...
if (isset($_POST['articulo_id'])) {
    ...
    $conexion->query("UPDATE comentarios SET likes = likes + 1 WHERE articulo_id = $articulo_id");
}
...
<head>
  ...
  <title><?= $articulo['titulo'] ?> - TechSolutions Blog</title>
        ...
        <link rel="stylesheet" href="Articulo.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <main>
        <div class="cabeza">
            ...
            <p id="datos"><small>📅 <?= $articulo['fecha'] ?> 🕒 <?= $articulo['tiempo_lectura'] ?> 🧑‍💻 <?= $articulo['autor'] ?></small></p>
        </div>
        <div class="articulo">
                ...
                <?php if ($resultado->num_rows > 0): ?>
                    <?php while ($row = $resultado->fetch_assoc()): ?>
                        <div class="cartas">
                                <div class="perfil">
                                    <div class="foto">
                                     <img src="<?= $row['perfil'] ?>" class="avatar">

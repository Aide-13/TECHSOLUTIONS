...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/Barra.css?v=<?php echo time(); ?>">
        <link rel="stylesheet" href="../assets/css/eventostec.css?v=<?php echo time(); ?>">
...
<header>
  ...
  <div class="slider-container">
        ...
        <div class="slider-content">
            <div class="slider-item active">
                <a href="https://www.eventbrite.com.mx/e/curso-de-robotica-con-mbot-aprende-a-programar-y-divertirte-desde-cero-tickets-1704206941839?aff=ebdssbcategorybrowse" target="blank"><img src="../assets/img/evento1.jpeg" width="1000"></a>
            </div>
            <div class="slider-item">
                <a href="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.facebook.com%2FFITMALatam%2F&psig=AOvVaw0vgw29uUY6Wbq76Gh4ZnhM&ust=1758239580705000&source=images&cd=vfe&opi=89978449&ved=0CBQQjhxqFwoTCLCvqYP_4I8DFQAAAAAdAAAAABAE" target="blank"><img src="../assets/img/evento4.jpg" width="1000"></a>
            </div>
            <div class="slider-item">
                <a href="https://www.eventbrite.com.mx/e/leon-cybersecurity-conference-tickets-1493440303149?aff=ebdssbcategorybrowse" target="blank"><img src="../assets/img/evento3.jpeg" width="1000"></a>
            </div>
        </div>
  ...
  <footer>
    ...
    <script src="../assets/js/Noticias_eventos.js"></script>
</html>